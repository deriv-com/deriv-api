// This file was automatically generated by scripts/regen-js.pl at 20190711-160302
...
export default class DerivAPICalls {
     ...
     * @param {String} args.address - [Optional] The address of the user. The maximum length of the address is 128 characters.
     ...
     * @param {String} args.name - Client's name. The maximum length of name is 128 characters.
     * @param {Any} args.passthrough - [Optional] field, used to pass data through the websocket, which may be retrieved via the echo_req output field.
     ...
     * @param {String} args.first_name - Within 2-30 characters, use only letters, spaces, hyphens, full-stops or apostrophes.
     ...
     * @param {String} args.last_name - Within 2-30 characters, use only letters, spaces, hyphens, full-stops or apostrophes.
     ...
     * @param {String} args.first_name - Within 2-30 characters, use only letters, spaces, hyphens, full-stops or apostrophes (can only be changed on unauthenticated svg accounts).
     * @param {String} args.last_name - Within 2-30 characters, use only letters, spaces, hyphens, full-stops or apostrophes (can only be changed on unauthenticated svg accounts).
     * @param {Any} args.passthrough - Optional field, used to pass data through the websocket, which may be retrieved via the echo_req output field.

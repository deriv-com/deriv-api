// This file was automatically generated by scripts/regen-js.pl at 20191111-103517
...
export default class DerivAPICalls {
     ...
     * @param {Any} args.passthrough - [Optional] Used to pass data through the websocket, which may be retrieved via the echo_req output field.
     * @param {Number} args.req_id - [Optional] Used to map request to response.
     * @param {String} args.totp_action - Action to be taken for managing TOTP (time-based one-time password, RFC6238). Generate will create a secret key which is then returned in the secret_key response field, you can then enable by using that code in a 2FA application.
     */
     ...
     * @param {Any} args.new_token_scopes - List of permission scopes to provide with the token.
     * @param {Any} args.passthrough - [Optional] Used to pass data through the websocket, which may be retrieved via the echo_req output field.
     * @param {Number} args.req_id - [Optional] Used to map request to response.
    ...
    /**
     * @param {Object} args
     * @param {String} args.account - [Optional] If set to 'all', return the balances of all accounts one by one; if set to 'current', return the balance of current account; if set as an account id,  return the balance of that account. Default is current
     * @param {Number} args.balance - Must be 1
     * @param {Any} args.passthrough - [Optional] Used to pass data through the websocket, which may be retrieved via the echo_req output field.
     * @param {Number} args.req_id - [Optional] Used to map request to response.
     * @param {Number} args.subscribe - If set to 1, will send updates whenever the balance changes.
     */
    balance(args = {}) {
        const config = {
            'account' : {
    ...
    /**
     * @param {Object} args
     * @param {String} args.cashier - Either deposit or withdraw, default to deposit.
     * @param {Any} args.passthrough - [Optional] Used to pass data through the websocket, which may be retrieved via the echo_req output field.
     * @param {String} args.provider - Note only doughflow is supported currently.
     * @param {Number} args.req_id - [Optional] Used to map request to response.
     ...
     * @param {String} args.landing_company - [Optional] Indicates which landing_company to get a list of contracts for. If you are logged in, your landing company will override this field.
     * @param {Any} args.passthrough - [Optional] Used to pass data through the websocket, which may be retrieved via the echo_req output field.
     ...
     * @param {String} args.page_type - Optional field to determine document side
     * @param {Any} args.passthrough - [Optional] Used to pass data through the websocket, which may be retrieved via the echo_req output field.
     * @param {Number} args.req_id - [Optional] Used to map request to response.
     */
    documentUpload(args = {}) {
     ...
     * @param {String} args.mt5_account_type - Standard: Variable spreads, High leverage. Advanced: Variable spreads, Medium Leverage, more products.
     ...
     * @param {String} args.password_type - The password type main/investor (default: 'main')
     * @param {Number} args.req_id - [Optional] Used to map request to response.
     */
     ...
     * @param {String} args.account_turnover - The anticipated account turnover
     ...
     * @param {String} args.binary_options_trading_experience - Binary options trading experience
     * @param {String} args.binary_options_trading_frequency - Binary options trading frequency
     * @param {String} args.cfd_trading_experience - CFDs trading experience
     * @param {String} args.cfd_trading_frequency - CFDs trading frequency
     * @param {String} args.citizen - Country of legal citizenship, 2-letter country code.
     * @param {String} args.client_type - Optional field, indicates whether this is for a client requesting an account with professional status. Defaults to retail.
     ...
     * @param {String} args.employment_status - Employment Status
     ...
     * @param {String} args.forex_trading_experience - Forex trading experience
     * @param {String} args.forex_trading_frequency - Forex trading frequency
     ...
     * @param {String} args.other_instruments_trading_experience - Trading experience in other financial instruments
     * @param {String} args.other_instruments_trading_frequency - Trading frequency in other financial instruments
     * @param {Any} args.passthrough - [Optional] Used to pass data through the websocket, which may be retrieved via the echo_req output field.
     ...
     * @param {String} args.secret_question - Accept any value in enum list.
     * @param {String} args.source_of_wealth - Source of wealth
     ...
     * @param {String} args.account_turnover - The anticipated account turnover
     * @param {String} args.address_city - Within 35 characters
     * @param {String} args.address_line_1 - Mailing address.
     * @param {String} args.address_line_2 - Optional field, within 70 characters.
     * @param {String} args.address_postcode - Optional field, within 20 characters and may not contain '+'.
     * @param {String} args.address_state - Optional field, possible value receive from 'states_list' call.
     * @param {String} args.affiliate_token - Affiliate token, within 32 characters.
     ...
     * @param {String} args.client_type - Optional field, indicates whether this is for a client requesting an account with professional status. Defaults to retail.
     * @param {String} args.currency - Optional field to set currency of the account. List of supported currencies can be acquired with 'payout_currencies' call
     * @param {String} args.date_of_birth - Date of birth format: yyyy-mm-dd.
     * @param {String} args.first_name - Within 2-50 characters, use only letters, spaces, hyphens, full-stops or apostrophes.
     * @param {String} args.last_name - Within 2-50 characters, use only letters, spaces, hyphens, full-stops or apostrophes.
     ...
     * @param {String} args.secret_question - Accept any value in enum list. Required for new account and existing client details will be used if client open another account.
     * @param {String} args.tax_identification_number - Tax identification number. Only applicable for real money account. Required for maltainvest landing company.
     * @param {String} args.tax_residence - Residence for tax purpose. Comma separated iso country code if multiple jurisdictions. Only applicable for real money account. Required for maltainvest landing company.
     */
    newAccountReal(args = {}) {
     ...
     * @param {Number} args.dry_run - If set to 1, just do validation.
     * @param {Any} args.passthrough - [Optional] Used to pass data through the websocket, which may be retrieved via the echo_req output field.
     ...
     * @param {String} args.basis - Indicates whether amount is 'payout' or 'stake'.
     ...
     * @param {Number} args.multiplier - The multiplier for non-binary options. E.g. lookbacks.
     * @param {Any} args.passthrough - [Optional] Used to pass data through the websocket, which may be retrieved via the echo_req output field.
     * @param {String} args.product_type - The product type.
     ...
     * @param {String} args.basis - Indicate whether amount is 'payout' or 'stake'.
     ...
     * @param {String} args.salutation - Accept any value in enum list (can only be changed on unauthenticated svg accounts).
     ...
     * @param {String} args.secret_question - Accept any value in enum list. Required for new account and existing client details will be used if client opens another account.
     ...
     * @param {Any} args.passthrough - [Optional] Used to pass data through the websocket, which may be retrieved via the echo_req output field.
     * @param {Number} args.req_id - [Optional] Used to map request to response.
     * @param {Number} args.subscribe - If set to 1, will send updates whenever a new tick is received.
     ...
     * @param {String} args.style - The tick-output style.
     ...
     * @param {String} args.accounts - Optional field to control the list of accounts returned when account_from or account_to is not provided. 'Brief' will only include standard trading accounts and can be faster.
     * @param {Number} args.amount - The amount to transfer.
     * @param {String} args.currency - Currency code
     * @param {Any} args.passthrough - [Optional] Used to pass data through the websocket, which may be retrieved via the echo_req output field.
     * @param {Number} args.req_id - [Optional] Used to map request to response.
     ...
     * @param {Any} args.passthrough - [Optional] Used to pass data through the websocket, which may be retrieved via the echo_req output field.
     * @param {Number} args.req_id - [Optional] Used to map request to response.
     * @param {Number} args.subscribe - [Optional] 1 - to stream the server/website status updates (default = 1)

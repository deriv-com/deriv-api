...
*   `args` **[Object][256]**  (optional, default `{}`)
    ...
    *   `args.assets` **Any** Optional field, used to set assets to be copied. E.x \["frxUSDJPY", "R\_50"]
